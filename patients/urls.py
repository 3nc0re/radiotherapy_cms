...
urlpatterns = [
    ...
    path('patients/<str:filter_type>/', views.patient_list, name='patient_list_filtered'),
    ...
    path('patient/<int:patient_pk>/generate_fractions/', views.generate_fractions, name='generate_fractions'),
