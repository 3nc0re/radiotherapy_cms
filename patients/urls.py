...
urlpatterns = [
    ...
    path('calendar/', views.patient_calendar, name='patient_calendar'),
    path('api/calendar/events/', views.calendar_events_api, name='calendar_events_api'),
    path('api/calendar/reschedule-event/', views.calendar_reschedule_event_api, name='calendar_reschedule_event_api'),
    path('protocols/', views.treatment_protocol_list, name='treatment_protocol_list'),
    path('api/protocols/', views.get_protocols_api, name='get_protocols_api'),
    path('api/protocols/save/', views.save_protocol_api, name='save_protocol_api'),
    path('api/protocols/<int:pk>/delete/', views.delete_protocol_api, name='delete_protocol_api'),
    ...
    path('api/patients/standardize-diagnosis/', views.standardize_diagnosis_api, name='standardize_diagnosis_api'),
    ...
    path('api/patients/search-for-inpatient/', views.search_patients_for_inpatient_api, name='search_patients_for_inpatient_api'),
