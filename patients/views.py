...
def dashboard(request):
    ...
    quotes = [
        ...
        "💡 Папір все стерпить, але історія хвороби — це документ про людське життя",
        "💡 Промінь надії завжди має правильну геометрію та точне дозування",
        "💡 Лікар з радіаційної онкології бачить світ крізь призму ізодоз та віри у перемогу",
        "💡 У медицині немає дрібниць, особливо коли йдеться про розмітку КТ та розрахунок СОД",
        "💡 Історія хвороби має бути написана так, щоб навіть через роки читалася як тріумф життя",
        "💡 Світло променевої терапії розсіює темряву найважчих онкологічних діагнозів",
        "💡 Наша робота — це тиха боротьба, де кожна успішна фракція наближає одужання",
        "💡 Лікар — це не просто професія, це спосіб життя, виміряний у фракціях та вдячних пацієнтах",
        "💡 Сила волі пацієнта подвоює ефективність будь-якої променевої терапії"
    ]
